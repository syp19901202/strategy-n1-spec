...
## Three-way (delay1 still running)
...
| delay 1 session (10bp / 1bp, delay true) | pending | pending | pending | pending | pending | pending | pending |

Overall three-way gate: **not closed** until delay1 finishes.
